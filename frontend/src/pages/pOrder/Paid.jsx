...
import { Validorder } from './POrder/ValidOrder/Validorder';
...
export const Paid = ({Address,bascketUser,valuePhone,IsShowWrapperCHeck,setIsShowWrapperCHeck,setNextPage,successPop
  ,setsuccessPop}) => {
  ...
  return (
    <section className='h-[100vh] overflow-y-auto w-full max-w-[1200px] mx-auto bg-gray-50 p-4 rounded-lg'>
      ...
      <div className='flex items-center space-x-5'>
        ...
        {/* <p className='bg-red-600 py-1 px-2 rounded-md'>Not Delivered</p> */}
    ...
    >
      ...
      >
        ...
        <div className="md:col-start-10 md:col-end-13 space-y-3 shadow-lg">
          ...
          <div>
           <button onClick={() =>setIsshowValid(!IsshowValid)} className="bg-primary-700 rounded-md py-2 text-lg front-[600] mt-3 px-2 text-white w-full block mx-auto transition duration-300 hover:bg-primary-800">throw order</button> 
          </div>
        
          </div>
        </div>
        </div>
       {IsshowValid && <Validorder successPop={successPop} setsuccessPop={setsuccessPop} setNextPage={setNextPage} IsShowWrapperCHeck={IsShowWrapperCHeck} setIsShowWrapperCHeck={setIsShowWrapperCHeck} IsshowValid={IsshowValid} user={user} Address={Address} valuePhone={valuePhone} setIsshowValid={setIsshowValid}/>} 
      </motion.article>
    </motion.section>}
    </section>
  )
