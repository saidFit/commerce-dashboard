...
export const PopUpSucc = ({successPop,setsuccessPop}) => {
  return (
    <section className='bg-[#00000067] fixed inset-0 z-50'>
      ...
      <div style={{...absoluteCenter2}} className='bg-gray-50 space-y-12 w-full max-w-[700px] rounded-md border border-gray-200 p-1'>
       <div className='flex items-center justify-center space-x-3 text-ms md:text-lg font-[700] p-16'>
       <p>
