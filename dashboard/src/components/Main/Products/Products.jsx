...
export const Products = ({successPop,setsuccessPop}) => {
  ...
  return (
    <>
      ...
      <h1 className="relative text-xl w-fit font-[500] before:absolute before:bg-gradient-blue before:w-full before:h-0.5 before:rounded-lg before:bottom-0 before:left-0 before:right-0">Products</h1>
      ...
      {IsEditPro && <EditPro 
                         ...
                         setIsEditPro={setIsEditPro}
                          ...
                          successPop={successPop} setsuccessPop={setsuccessPop}
                          />}
    </>
